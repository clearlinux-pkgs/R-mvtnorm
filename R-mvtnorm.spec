...
Version  : 1.1.2
Release  : 85
URL      : https://cran.r-project.org/src/contrib/mvtnorm_1.1-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/mvtnorm_1.1-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623084111
