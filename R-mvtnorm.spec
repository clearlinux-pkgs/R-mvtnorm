...
Version  : 1.0.7
Release  : 53
URL      : https://cran.r-project.org/src/contrib/mvtnorm_1.0-7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/mvtnorm_1.0-7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1517332339
